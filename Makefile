...
CFLAGS_HEADPACK := -g $(INCLUDES_UNILAYER) -Iunilayer/tools -DNO_RESEXT -DDEBUG_THRESHOLD=3 -DRESOURCE_FILE -DASSETS_PATH="\"$(ASSETPATH)\"" -DDEBUG_LOG -DDISABLE_WEATHER_EFFECTS
...
CFLAGS_MKRESH := -DNO_RESEXT -g -DDEBUG_LOG -DDEBUG_THRESHOLD=0 -DRESOURCE_FILE $(INCLUDES_UNILAYER) -DASSETS_PATH="\"$(ASSETPATH)\""
