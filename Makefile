...
CFLAGS_HEADPACK := -g $(INCLUDES_UNILAYER) -Iunilayer/tools -DNO_RESEXT -DDEBUG_THRESHOLD=1 -DRESOURCE_FILE -DASSETS_PATH="\"$(ASSETPATH)\"" -DDEBUG_LOG -DDISABLE_WEATHER_EFFECTS -DNO_GUI
